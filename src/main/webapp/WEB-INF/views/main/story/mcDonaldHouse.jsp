				...
				<div class="contArea">
					<div class="inner">
						<ul class="tabType01">
							...
							<li><a href="/story/society/mcDonaldHouse.do" role="button" aria-selected="true">재단법인 로날드맥도날드하우스</a></li>
						</ul>
						
						<div class="socialTab">
							<div class="img"><img src="https://edonaldfile.s3.ap-northeast-2.amazonaws.com/common/main/img_social02_04_01.jpg" alt="로날드 맥도날드 하우스 대표이미지"></div>
