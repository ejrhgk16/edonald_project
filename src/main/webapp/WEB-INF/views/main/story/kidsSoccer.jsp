...
<div class="visualArea bgStory02" data-title="맥도날드 사회적 책임" data-desc="어린이 축구교실">
				...
				<div class="contArea">
					<div class="inner">
						<ul class="tabType01">
							<li><a href="/story/society/kidsSoccer.do" role="button" aria-selected="true">로날드 맥도날드 어린이 축구교실</a></li>
						...
						<div class="socialTab">
							<div class="img"><img src="https://edonaldfile.s3.ap-northeast-2.amazonaws.com/common/main/img_social02_01_01.jpg" alt="어린이축구교실 대표이미지"></div>
							...
							<div class="socialList">
								<ul>
									<li>
										<span class="thum"><img src="https://edonaldfile.s3.ap-northeast-2.amazonaws.com/common/main/img_social02_01_02.jpg" alt="아빠와 함께하는 축구교실 이미지"></span>
									...
									<li>
										<span class="thum"><img src="https://edonaldfile.s3.ap-northeast-2.amazonaws.com/common/main/img_social02_01_03.jpg" alt="학교방문 축구교실 이미지"></span>
									...
									<li>
										<span class="thum"><img src="https://edonaldfile.s3.ap-northeast-2.amazonaws.com/common/main/img_social02_01_04.jpg" alt="다문화 어린이 축구교실 이미지"></span>
									...
									<li>
										<span class="thum"><img src="https://edonaldfile.s3.ap-northeast-2.amazonaws.com/common/main/img_social02_01_06.jpg" alt="특수학교 축구교실 이미지"></span>
