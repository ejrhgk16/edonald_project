					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="layout-static.jsp">쿠폰관리</a> <a
									class="nav-link" href="orderstate.jsp">주문관리</a>
							</nav>
						</div>
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sb-sidenav-menu-nested nav accordion"
								...
								<div class="collapse" id="pagesCollapseAuth"
									...
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="notice.jsp">공지사항</a> <a
											...
											class="nav-link" href="board2.html">qna</a> <a
											class="nav-link" href="checkmenu.jsp">추천메뉴</a> <a
											class="nav-link" href="burgerNset.jsp">버거n세트</a> <a
											class="nav-link" href="snackNside.jsp">스낵n사이드</a> <a
								...
								<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
									...
									aria-controls="pagesCollapseError"> 회원관리
									<div class="sb-sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a>
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">해피밀메뉴</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
						<li class="breadcrumb-item active">해피밀메뉴</li>
					</ol>


					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> 맥도날드 해피밀메뉴 내역
						</div>
						<div>
							<br> &nbsp;&nbsp;&nbsp;
							<button type="button" onclick="window.open('addhappymeal.jsp');"
								class="btn btn-outline-dark">등록</button> &nbsp;<button type="button" class="btn btn-outline-dark">저장</button>
