            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">디저트메뉴</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">디저트메뉴</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div>
                            <br>
                          &nbsp;&nbsp;&nbsp;<button type="button" onclick="window.open('dessertRegister.jsp');"class="btn btn-outline-dark">등록</button>&nbsp;<button type="button" class="btn btn-outline-dark">저장</button>
							...
							<table id="datatablesSimple">
								...
								<tbody>
									...
									<c:forEach var="list" items="${list}">
										<tr>
											<td>${list.dessert_name}</td>
											<td>${list.dessert_price}</td>
											<td>${list.dessert_code}</td>
											<td>${list.dessert_kcal}</td>
                            <td>
                                <select name="role">
