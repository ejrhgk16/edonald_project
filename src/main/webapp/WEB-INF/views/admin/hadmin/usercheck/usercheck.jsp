								...
								<div class="collapse" id="pagesCollapseAuth"
									...
									<nav class="sb-sidenav-menu-nested nav">
										<a class="nav-link" href="notice.jsp">공지사항</a> <a
											...
											class="nav-link" href="qna.jsp">q＆a</a> <a class="nav-link"
											href="checkmenu.jsp">추천메뉴</a> <a class="nav-link"
											href="burgerNset.jsp">버거＆세트</a> <a class="nav-link"
											href="snackNside.jsp">스낵＆사이드</a> <a class="nav-link"
											href="drink.jsp">음료</a> <a class="nav-link"
