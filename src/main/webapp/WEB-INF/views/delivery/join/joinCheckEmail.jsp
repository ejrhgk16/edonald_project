				...
				<div
					...
					<p>
						<i class="fa fa-exclamation text-white icon"></i> <span>메뉴는
							<span class="text-primary timer menuswitch-timer">54:07</span> 분
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-3 timer-wrapper">
										...
										<div class="time timer text-din timer-clock menuswitch-timer">54:07</div>
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-3 timer-wrapper">
										...
										<div class="time timer text-din timer-clock storeclose-timer">4:07</div>
									</div>
									<div class="col-xs-8 timer-wrapper">
										<div class="alert-content text-left">
				...
				<div class="page-content">
					<div class="panel panel-lg panel-default type-sans">
						<div class="panel-heading">
							<h3>고객님께 이메일을 전송했습니다.</h3>
						</div>
						<div class="panel-body">
							<p>
								입력한 이메일 주소 <strong>~~~</strong> 로 인증메일이 발송되었습니다.
							</p>
							<p>회원 가입을 위해 이메일 내용을 확인하세요.</p>
							<p>
								5분안에 인증 메일을 받지 못하신 경우, 스팸 메일을 확인하시거나 인증 메일 재발송을 위해 <a
									href="sendActivate.html">여기</a>를 클릭하세요.
							</p>
						</div>
					</div>
				</div>
