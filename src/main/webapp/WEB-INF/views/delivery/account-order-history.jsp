...
<div class="root">
	<div class="wrap container">
				...
				<!-- Start of Session time out warning -->
						...
						<div class="alert alert-warning alert-dismissable inline-alert type-flama hidden alert-session-timeout" data-dismiss-trigger="session.action.continue">
							...
							<p>
								...
								선택하신 제품의 주문 가능 시간이 <span class="text-primary timer session-timer">12:59</span>분 남았습니다. 주문을 완료해 주세요.
							</p>
						</div>
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-3 timer-wrapper">
										...
										<div class="time timer text-din timer-clock menuswitch-timer">54:30</div>
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-xs-3 timer-wrapper">
										...
										<div class="time timer text-din timer-clock storeclose-timer">54:30</div>
									</div>
									<div class="col-xs-8 timer-wrapper">
										<div class="alert-content text-left">
						...
						<div class="sidebar-menu">
							...
							<ul class="menu">
								<li class="menu-item"><a class="menu-item-target" href="/kr/trackorder.html">주문 조회</a></li>
									...
									<li class="menu-item selected"><a class="menu-item-target" href="/kr/account-order-history.html">주문 내역</a></li>
		...
		<div class="row type-sans">
			<div class="col-xs-6"><p>최근 5일간의 주문 내역이 나타납니다.</p></div>
			<div class="col-xs-6 text-right"><a class="showall-accordion" href="#">모두 보기</a> | <a href="#" class="hideall-accordion">모두 숨기기</a></div>
		</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row collapse-row">
							<div class="collapse-col col-xs-1"><a data-toggle="collapse" class="btn btn-red accordion-state accordion-state-expanded" data-target="#order-310442" aria-expanded="true"><i class="fa icon"></i></a></div>
							<div class="collapse-col col-xs-7 date">주문 일자: 2022/03/25 13:18 </div>
						</div>
					</div>
					<div class="order-history-collapse panel-body collapse in" id="order-310442" aria-expanded="true" style="">
						<div>
							<div class="col-xs-3 order-history-detail">
								<table class="table-default table-order-history-detail">
									<tbody>
							         ...
							         <tr> 									
                                       <td class="order-id"><a href="/kr/searchOrder.html?orderNum=1140535-25%2F03%2F2022-310442">1140535-25/03/2022-310442</a> </td>
                                     </tr>
                                       
                                     <tr>
										<th class="delivery-time-title">배달 시간:</th>
									</tr>
							         <tr> 
                                       	
													<td class="delivery-Time"><div>2022/03/25 14:30</div> </td>
										
										
                                     </tr> 
                                      <tr>
											<th class="address-title">주소:</th>
									</tr>
							          <tr> 
                                       <td class="address"><div>서울특별시 강북구 미아동 791-961 4층</div> </td>
                                      </tr>                                       
         							</tbody>
								</table>
							</div>
							...
							<div class="col-xs-4">
								<div class="order-history-total">
									...
									<a class="btn btn-default btn-red btn-block btn-lg action-ordernow" href="/kr/reorder.html?orderId=1140535-25%2F03%2F2022-310442&amp;source=account-order-history.html" data-orderid="1140535-25/03/2022-310442">재 주문</a>
									
									
									<div class="save-to-fav">
										<a class="saveFav action-addtofavourites" href="#" data-orderid="1140535-25/03/2022-310442">
											<i class="fa mcd mcd-favourite icon"></i>
											선호 메뉴로 저장하기
										</a>
									</div>
								</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading text-right">
									<a class="btn btn-red btn-lg" href="/kr/menu.html">새로 주문하기</a>
							</div>
						</div>
